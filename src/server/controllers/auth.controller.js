...
const register = async (req, res) => {
  try {
    ...
    // Added more explicit conversion to ensure proper admin value
    const adminValue = is_admin === true || is_admin === 1 || is_admin === "1" || is_admin === "true" ? 1 : 0;
    
    // Log for debugging
    console.log('Admin value being stored:', adminValue, 'Original value:', is_admin, 'Type:', typeof is_admin);
